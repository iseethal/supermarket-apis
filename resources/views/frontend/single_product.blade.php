...
<div class="breadcrumbs_area">
    ...
    <div class="shop_area shop_reverse mt-50 mb-50">
                                    ...
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" >
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="{{ asset('images/product_images/'.$singleProduct->image) }}" alt=""></a>    
                                            </div>
                                        </div>
         ...
         <div class="input-group mb-3" style="width:115px" >
        ...
        <div class="input-group quantity">
            ...
            <input type="text" id="product_qty" class="qty-input form-control" maxlength="1" max="10" value="1">
